...
Each file (one for each of the 120 images showed to the obdervers during the test) contains a list of gaze data point where each row is a single gaze point and the columns correspond to:<br>  
